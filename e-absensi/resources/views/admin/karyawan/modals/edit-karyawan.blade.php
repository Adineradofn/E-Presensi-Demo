{{-- Modal: Edit --}}
<div id="modalEdit" class="modal fixed inset-0 items-center justify-center bg-black/40 z-50">
  <div class="bg-white w-full max-w-xl rounded-lg shadow p-5">
    <h3 class="text-lg font-semibold mb-3">Ubah Data Karyawan</h3>
    <form id="formEdit" class="grid grid-cols-2 gap-3">
      @csrf
      ...
      <div class="col-span-2">
        ...
        <input name="foto" class="w-full border rounded px-3 py-2">
      </div>
      <div class="col-span-2">
      ...
      <div class="col-span-2 flex justify-end gap-2 mt-2">
        <button type="button" class="btnCloseEdit px-4 py-2 border rounded">Batal</button>
